 ...
 * thus, given the same value of <i>lgConfigK</i>, all three HLL target types will produce
 * identical error results given the same input.</p>
 *
 ...
 *
 * <li><b>HLL_4</b> This uses a 4-bit field per HLL bucket and requires the use of a small
 * internal auxiliary array for storing statistical exceptions, which are rare.
 ...
 * terms of update time, but has the smallest storage footprint of about <i>K/2 * 1.03</i> bytes.</li>
 * </ul>
