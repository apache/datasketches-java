...
public abstract class QuantilesSketch {
   ...
   * This method incurrs the internal set-up overhead once and obtains multiple quantile values in 
  ...
  /**
   * This is also a more efficent multiple-query version of getQuantile() and allows the caller to
