...
public class ItemsSketchTest {
  ...
  public void empty() {
    ...
    final byte[] byteArr = sketch.toByteArray(new ArrayOfStringsSerDe2());
  ...
  public void serializeDeserializeLong() {
    ...
    final ArrayOfItemsSerDe2<Long> serDe = new ArrayOfLongsSerDe2();
  ...
  public void serializeDeserializeDouble() {
    ...
    final ArrayOfItemsSerDe2<Double> serDe = new ArrayOfDoublesSerDe2();
    final byte[] bytes = sketch1.toByteArray(serDe);
  ...
  public void serializeDeserializeString() {
    ...
    final ArrayOfItemsSerDe2<String> serDe = new ArrayOfStringsSerDe2();
    final byte[] bytes = sketch1.toByteArray(serDe);
  ...
  public void checkGetInstanceExcep1() {
    ...
    ItemsSketch.getInstance(String.class, mem, Comparator.naturalOrder(), new ArrayOfStringsSerDe2());
  }
  ...
  public void compactNotSupported() {
    final ArrayOfDoublesSerDe2 serDe = new ArrayOfDoublesSerDe2();
  ...
  public void checkPutMemory() {
    ...
    final MemorySegment mem = MemorySegment.ofArray(byteArr);
    sketch.putMemorySegment(mem, new ArrayOfStringsSerDe2());
  }
  ...
  public void checkIssue484() {
    ...
    final byte[] serialized = sketch.toByteArray(new ArrayOfBooleansSerDe2());
    final ItemsSketch<Boolean> deserialized =
        ItemsSketch.getInstance(Boolean.class, MemorySegment.ofArray(serialized), Boolean::compareTo, new ArrayOfBooleansSerDe2());
