...
public class DirectQuickSelectSketchTest {
  ...
  public void checkCorruptLgNomLongs() {
    ...
    try (Arena arena = Arena.ofConfined()) {
      ...
      Sketch.heapify(wmem, Util.DEFAULT_UPDATE_SEED);
    } catch (final Exception e) {
      if (e instanceof SketchesArgumentException) {}
      else { throw new RuntimeException(e); }
    }
  ...
  public void checkConstructorSrcMemCorruptions() {
    ...
    try {
      usk2 = DirectQuickSelectSketch.writableWrap(mem1, Util.DEFAULT_UPDATE_SEED);
    ...
    try {
      usk2 = DirectQuickSelectSketch.writableWrap(mem2, Util.DEFAULT_UPDATE_SEED);
      fail("Expected SketchesArgumentException");
    } catch (SketchesArgumentException e) {
      //pass
    }
  ...
  public void checkCorruptRFWithInsufficientArray() {
    ...
    UpdateSketch dqss = DirectQuickSelectSketch.writableWrap(mem, Util.DEFAULT_UPDATE_SEED);
